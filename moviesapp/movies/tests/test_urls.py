...
class TestMovieURLs(TestCase):
    ...
    #     self.assertEqual(reverse('movies:detail', kwargs={'pk': '1'}), '/movies/1/')
    #     self.assertEqual(reverse('movies:create'), '/movies/create/')
    #     self.assertEqual(reverse('movies:update', kwargs={'pk': '1'}), '/movies/update/1/')
    #     self.assertEqual(reverse('movies:delete', kwargs={'pk': '1'}), '/movies/delete/1/')
